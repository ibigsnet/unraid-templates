...
| [Fabric Routing (FRR)](plugins/unraidfrr.xml) | Plugin | Optional FRR packages/daemons — [ibigsnet/UnraidFRR](https://github.com/ibigsnet/UnraidFRR); pairs with Thunderbolt Net for OpenFabric |
